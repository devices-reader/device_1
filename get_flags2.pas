...
begin
  ...
  AddInfo('флаги: ' + IntToHex(i,2) + ' ' + IntToHex(j,2));
  
  if j and $01 = 0 then s := '0, да' else s := '1, нет';
  AddInfo('флаг 0x'+IntToHex(j,2)+'.0 = ' + s + ' - автоматическому переходу на летнее/зимнее время');
